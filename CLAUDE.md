...
- **남은 작업·재개 우선순위:** [9/8 상태표](docs/2026-09-08-remaining-work.md). 핵심 로컬 기능은 구현됐으며 실제 수행일·마감·백업·일정 변경 등의 후속 제안과 구독/문의 연결·실기기 미검증을 구별한다. 사용자는 랜딩 시안을 집에서 나중에 확인할 예정이다.
...
- 운동 저장은 v1 읽기 이행 + v2 쓰기다. D5 이력을 모르는 구버전 앱이 새 파일을 덮어쓰지 않도록 새 버전 파일을 거부하는 계약을 유지한다.
...
- 최신 검증 결과와 19개 기능의 근거/한계는 [9/7 자체 검증](docs/2026-09-07-verification.md)을 우선한다.
