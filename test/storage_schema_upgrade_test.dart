...
void main() {
  test('기존 v1을 이행하고 v2로 저장하여 구버전 덮어쓰기를 막는다', () async {
    ...
    final legacyJson = old.toJson()..remove('loadAdjustments');
    ...
    final future = jsonEncode({'schemaVersion': 3, 'state': restored.toJson()});
